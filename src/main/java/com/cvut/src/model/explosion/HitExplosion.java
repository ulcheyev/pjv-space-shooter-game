...
public class HitExplosion extends Explosion {
    private static final String IMG_PATH = "/exp2.png";

    //Column quantity * Row quantity in sprite image
    private static final int TOTAL_NUMBER_OF_FRAMES = 32;

    private static final int TOTAL_COLUMN_NUMBER_IN_SPRITE_IMAGE = 8;
    private static final float WIDTH_OF_THE_CUT_OUT_FRAGMENT = 91.5f;
    private static final float HEIGHT_OF_THE_CUT_OUT_FRAGMENT = 90;
    private static final float WIDTH_OF_THE_IMAGE_FROM_ORIGINAL_IMAGE = 100;
    private static final float HEIGHT_OF_THE_IMAGE_FROM_ORIGINAL_IMAGE = 100;
